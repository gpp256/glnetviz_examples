...
function plot() {
  var sdate = '2012/08/24';
  var edate = '2012/08/31';
  var xaxisFormat = '%Y/%m/%d %H:%M';
  var ymax = null;
  var graph_label = "Load Average (Controller01)";
  var yaxis_label = "Number of Processes";
  var line1 = data.line01; var line1_label = "1m";
  var line2 = data.line02; var line2_label = "5m";
  var line3 = data.line03; var line3_label = "15m";

  var jqplot = $.jqplot('chart', [line1, line2, line3], {
    legend: {
    show:true,
    ...
    title: {text: graph_label, fontSize: '12px'},
    grid: {background:'#f3f3f3', gridLineColor:'#accf9b'},
    animate: true,
    animateReplot: true,
    series: [
        {label:line1_label, rendererOptions: { smooth: true, animation: { speed: 2500 } }, lineWidth: 0.5, showMarker: false },
        {label:line2_label, rendererOptions: { smooth: true, animation: { speed: 2500 } }, lineWidth: 0.5, showMarker: false },
        {label:line3_label, rendererOptions: { smooth: true, animation: { speed: 2500 } }, lineWidth: 0.5, showMarker: false }
    ],
    axes: {
      xaxis:{
        ...
        numberTicks: 7,
        label: 'Time',
        labelOptions: { fontSize: '8px', textColor: '#ffffff' },
        tickOptions: { angle: -20, fontSize: '8px', formatString: xaxisFormat, textColor: '#ffffff' }
      },
      yaxis:{
        labelRenderer: $.jqplot.CanvasAxisLabelRenderer,
        label: yaxis_label,
        labelOptions: { fontSize: '8px', textColor: '#ffffff' },
        tickOptions: { fontSize: '8px' },
        min:0,
        max: ymax
      }
    },
    highlighter: {
      ...
      tooltipAxes: 'y',
      tooltipSeparator: '',
      tooltipFormatstring: '<strong>%f</strong>'
    },
